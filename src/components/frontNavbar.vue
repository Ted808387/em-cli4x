        ...
        <header class="navbar navbar-expand navbar-light justify-content-between">
          ...
          <div calss="productModal">
            <div class="modal-cart" :class="{'opacity-cart' : cart}" @click.stop="cart = true">
              ...
              <p class="mb-0 text-center font-weight-bold mt-2 mb-3"
              v-if="Cart.total !== 0">－&nbsp;你的購物車&nbsp;－
              </p>
              <table class="table mt-1 mx-auto" v-if="Cart.total !== 0">
                ...
                <tfoot>
                  <tr class="d-block">
                    <td colspan="4" class="text-right" style="width:100%;">總計</td>
            ...
            <div class="modal-favorite"
              ...
              <table class="table mt-1 mx-auto" v-if="Favorite.length !== 0">
                <tbody class="modal-favorite_item">
